    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white border border-[#E2E8F0] text-sm text-[#475569]">
          <Palette className="size-3.5 text-[#94A3B8]" aria-hidden="true" />
          <span className="font-semibold text-[#1e344a]">{pi.items.length}</span> total
        </div>
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-50 border border-emerald-200 text-sm text-emerald-800">
          <CircleCheck className="size-3.5 text-emerald-500" aria-hidden="true" />
          <span className="font-semibold">{pi.activeCount}</span> aktif
        </div>
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0] text-sm text-[#64748B]">
          <CircleX className="size-3.5 text-[#94A3B8]" aria-hidden="true" />
          <span className="font-semibold">{pi.inactiveCount}</span> nonaktif
        </div>
      </div>
